...
public final class DefaultToApiJsonSerializer<T> implements ToApiJsonSerializer<T> {
    ...
    private final ExcludeNothingWithPrettyPrintingOnWithTimeJsonSerializerGoogleGson excludeNothingWithPrettyPrintingOnTime;
    private final ExcludeNothingWithPrettyPrintingOffWithTimeJsonSerializerGoogleGson excludeNothingWithPrettyPrintingOffTime;
    ...
    public DefaultToApiJsonSerializer(
            ...
            final ExcludeNothingWithPrettyPrintingOnWithTimeJsonSerializerGoogleGson excludeNothingWithPrettyPrintingOnTime,
             final ExcludeNothingWithPrettyPrintingOffWithTimeJsonSerializerGoogleGson excludeNothingWithPrettyPrintingOffTime) {
        ...
        this.helper = helper;
        this.excludeNothingWithPrettyPrintingOnTime = excludeNothingWithPrettyPrintingOnTime;
        this.excludeNothingWithPrettyPrintingOffTime = excludeNothingWithPrettyPrintingOffTime;
    }
    ...
    public String serializeTime(final Object object) {
        return this.excludeNothingWithPrettyPrintingOffTime.serialize(object);
    }
