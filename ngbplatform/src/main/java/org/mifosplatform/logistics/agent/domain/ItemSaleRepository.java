...
public interface ItemSaleRepository extends JpaRepository<ItemSale, Long>,JpaSpecificationExecutor<ItemSale>{
	...
	@Query("from ItemSale itemSale where itemSale.itemId =:itemId and status='New'")
	ItemSale findItemsaleDetails(@Param("itemId") Long itemId);
